                            ...
                            <AnimatePresence>
                                {scanResult && (
                                    <motion.div
                                        ...
                                        animate={{ opacity: 1, y: 0 }}
                                        exit={{ opacity: 0, y: -20 }}
                                        className={`fixed bottom-12 left-4 right-4 md:left-auto md:right-8 md:w-96 p-6 rounded-2xl shadow-2xl flex items-center gap-4 border z-50 ${scanResult.success ? "bg-green-600 border-green-500 text-white" : "bg-red-600 border-red-500 text-white"}`}
                                    >
                                        <div className="bg-white/20 p-3 rounded-xl">
                                            {scanResult.success ? <CheckCircle size={32} /> : <XCircle size={32} />}
                                        </div>
                                        <div>
